...
AdaDion V2 achieves the best validation accuracy on CIFAR-10 ResNet-18 (96.20\%) while reducing communication volume by 1.8x compared to AdamW and Muon. On 4$\times$A100 DDP, AdaDion V2 runs at 57.6 ms/step, 3.6x faster than Muon (206.3 ms/step) with higher accuracy. The adaptive rank mechanism provides 0.18\% accuracy gain over non-adaptive Dion at 17\% compute overhead. On ViT-Small, the Dion family (92.2--92.4\%) outperforms both Muon (88.9\%) and AdamW (83.7\%).
